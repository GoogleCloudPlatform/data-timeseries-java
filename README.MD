...
### Running the sample
After downloading this sample you can run the example by changing to the timeseries directory and run the example using Maven by using the following command:
