...
import com.google.cloud.solutions.samples.timeseries.aggregation.CompleteTimeSeriesAggCombiner;
import com.google.cloud.solutions.samples.timeseries.aggregation.CreateMissingTimeSeriesValuesDoFn;
import com.google.cloud.solutions.samples.timeseries.aggregation.DetectMissingTimeSeriesValuesCombiner;
import com.google.cloud.solutions.samples.timeseries.aggregation.EmbedWindowTimeIntoAggregateDoFn;
import com.google.cloud.solutions.samples.timeseries.aggregation.PartialTimeSeriesAggCombiner;
import com.google.cloud.solutions.samples.timeseries.aggregation.TimeseriesUtils.TSTuple;
import com.google.cloud.solutions.samples.timeseries.coders.TimeSeriesCoders;
import com.google.cloud.solutions.samples.timeseries.computation.ComputeCorrelationsDoFn;
import com.google.cloud.solutions.samples.timeseries.computation.ComputeCorrelationsDoFn.CorrolationParDoConfig;
...
import com.google.cloud.solutions.samples.timeseries.tests.GenerateSampleData;
import com.google.cloud.solutions.samples.timeseries.workpackets.CreateWorkPacketsDoFn;
import com.google.cloud.solutions.samples.timeseries.workpackets.DistributeWorkDataDoFn;
import com.google.cloud.solutions.samples.timeseries.workpackets.FlattenKVIterableDoFn;
  ...
  public static void main(String[] args) throws Exception {
    ...
    PCollection<KV<String, TSProto>> windowedData =
        tsData.apply("CandleResolutionWindow", Window.<KV<String, TSProto>>into(FixedWindows
            .of(Duration.standardSeconds(options.getCandleResolution()))));
              ...
              public void processElement(
                ...
                if (c.timestamp().isBefore(new Instant(32530703764000L))) {
                  ...
                  if (c.timestamp().isAfter(
                    ...
                    LOG.error("There was a timestamp before earlier than the window and skew must be 0 :: "
    ...
    if (options.getEnableSampleLogging()) {
      ...
      completeAggregationStage3.apply("GroupByBeforeLoggingAggregates", GroupByKey.create()).apply(
          ParDo.of(new DoFn<KV<String, Iterable<TSAggValueProto>>, String>() {
    ...
    PCollection<KV<String, TSAggValueProto>> correlationWindow =
        completeAggregationStage3.apply(
            "SlidingWindowForCorrelations",
            Window.<KV<String, TSAggValueProto>>into(
    ...
    PCollection<KV<WorkPartition, Iterable<WorkDataPoint>>> distributed =
        correlationWindow.apply(ParDo.of(new DistributeWorkDataDoFn(packetConfig))).apply(
            GroupByKey.create());

    PCollection<WorkPackets> workPackets =
        distributed.apply(ParDo.of(new CreateWorkPacketsDoFn(packetConfig)));
