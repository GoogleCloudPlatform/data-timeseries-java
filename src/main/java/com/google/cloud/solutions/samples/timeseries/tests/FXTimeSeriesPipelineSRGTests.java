...
import com.google.cloud.solutions.samples.timeseries.pipelines.fx.FXTimeSeriesPipelineOptions;
import com.google.cloud.solutions.samples.timeseries.proto.TimeSeriesProtos.SimpleAggTester;
...
public class FXTimeSeriesPipelineSRGTests implements Serializable {
  ...
  public void testCompleteWindowData() {
    ...
    testData.add(KV.of(GenerateSampleData.TS3, TSProto.newBuilder().setKey(GenerateSampleData.TS3)
        .setIsLive(false).setTime(1451606639999L).build()));
  ...
  public void testCompleteCandleDataOneStream() {
    ...
    expectedList.add(SimpleAggTester.newBuilder().setKey(key).setCloseTime(1451606519999L)
        .setOpenStateTime(1451606460000L).setCloseStateTime(1451606460000L).setMinAskPrice(1)
        .setMaxAskPrice(2).setMinBidPrice(1).setMaxBidPrice(2).build());

    expectedList.add(SimpleAggTester.newBuilder().setKey(key).setCloseTime(1451606639999L)
        .setOpenStateTime(1451606460000L).setCloseStateTime(1451606580000L).setMinAskPrice(3)
        .setMaxAskPrice(4).setMinBidPrice(3).setMaxBidPrice(4).build());

    expectedList.add(SimpleAggTester.newBuilder().setKey(key).setCloseTime(1451606759999L)
        .setOpenStateTime(1451606580000L).setCloseStateTime(1451606700000L).setMinAskPrice(5)
        .setMaxAskPrice(5).setMinBidPrice(5).setMaxBidPrice(5).build());

    expectedList.add(SimpleAggTester.newBuilder().setKey(key).setCloseTime(1451606879999L)
        .setOpenStateTime(1451606700000L).setCloseStateTime(1451606820000L).setMinAskPrice(3)
        .setMaxAskPrice(4).setMinBidPrice(3).setMaxBidPrice(4).build());

    expectedList.add(SimpleAggTester.newBuilder().setKey(key).setCloseTime(1451606999999L)
        .setOpenStateTime(1451606820000L).setCloseStateTime(1451606940000L).setMinAskPrice(1)
        .setMaxAskPrice(2).setMinBidPrice(1).setMaxBidPrice(2).build());
